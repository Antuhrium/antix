...
import { isAdvisorPerson } from "../utils";
...
export const Content = (props: ContentProps) => {
  ...
  const [selectedElement, setSelectedElement] = useState<
    TeamPerson | AdvisorPerson | null
  >(null);

  const handleCardClick = (element: TeamPerson | AdvisorPerson) => {
    if (isAdvisorPerson(element)) return;
  ...
  return (
    <>
      <Modal visible={!!selectedElement} onClose={handleCloseModal}>
        <Details data={selectedElement} />
      </Modal>
