    ...
    return (
        <section className={styles.container}>
            ...
            <div className={styles.item}>
                ...
                <p>
                    <span>Adoption in Gaming and VR/AR Industries:</span> 40% of
                    new games and 50% of VR content to feature digital humans by
                    2025.
                </p>
            </div>
            <img
            ...
            <div className={styles.item}>
                <p style={{ maxWidth: 174 }}>
                    <span>Yearly market growth:</span> $10B in 2023, projected
                    to $30B by 2030, 20% CAGR.
                </p>
            ...
            <div className={styles.item} style={{ width: 506 }}>
                ...
                <p style={{ marginTop: 140 }}>
                    <span>Antix digital humans:</span> Seen by 100M+ viewers
            ...
            <div className={styles.item} style={{ width: 344 }}>
                <img src={Icon15m} alt="" />
                <p>
                    <span>Virtual influencers market growth:</span> $15B market
                    by 2025, triple the engagement of human.
                </p>
            </div>
            ...
            <div className={styles.minContent}>
                <div className={styles.item}>
                    ...
                    <p>
                        <span>Production cost and time reduction:</span> Antix
                        cuts digital human creation time from weeks to hours,
                        costs down by 90%.
                    </p>
                </div>
            ...
            <div className={styles.maxItem} style={{ width: 233 }}>
                ...
                <p>
                    <span>Cost of Pre-Antix digital characters:</span>{" "}
                    Ultra-realistic digital characters cost $100K-$500K, weeks
                    of production time.
                </p>
            </div>
        </section>
